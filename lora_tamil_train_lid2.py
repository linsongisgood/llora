...
path = './dravidian-codemix-2020/tamil-english/tamil_train.tsv'
path0_1 = './dravidian-codemix-2020/tamil-english/3/train_tamil.txt'

path1 = './dravidian-codemix-2020/tamil-english/tamil_test_answer.tsv'
path1_1 = './dravidian-codemix-2020/tamil-english/3/test_tamil.txt'
...
for i, j in zip(sentences, sentences0_1):
    tmp = i+'. '+j
    sentences_t.append(tmp)
...
sentences1_t = []
for i, j in zip(sentences2, sentences1_1):
    tmp = i + '. ' + j
    sentences1_t.append(tmp)
...
input_ids11 = torch.tensor(lang_tag(sentences_t))

for sent in sentences1_t:
...
input_ids22 = torch.tensor(lang_tag(sentences1_t))
# 把lists 转为 tensors.
# 把lists 转为 tensors.
