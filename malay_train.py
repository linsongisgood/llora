...
from xlm_roberta77777 import xlm_robertamodel


import pandas as pd


path = './dravidian-codemix-2020/malayam-english/malayalam_train.tsv'
path1 = './dravidian-codemix-2020/malayam-english/malayalam_test_results.tsv'
data = pd.read_csv(path, sep='\t')
data1 = pd.read_csv(path1, sep='\t')
#nclass= {"Negative ": 0, "Positive ": 1, "Mixed_feelings ": 2, "unknown_state ": 3, "not-malayalam": 4}
nclass= {"Negative ": 0, 'Negative': 0, 'Positive ': 1, 'Positive': 1, "Mixed_feelings ": 2, "Mixed_feelings": 2, "unknown_state ": 3, "unknown_state": 3, "not-malayalam": 4, "not-malayalam ": 4}
...
#tokenizer = AutoTokenizer.from_pretrained("../../../root/autodl-tmp/xlm_roberta_base")
