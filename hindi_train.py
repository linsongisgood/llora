...
sentences = []
labels = []
with open("./semeval2020/hinglish/3/train.txt", "r") as f:
    lines = f.readlines()
    for line in lines:
...
sentences2 = []
labels2 = []
with open("./semeval2020/hinglish/3/test.txt", "r") as f:
    lines = f.readlines()
    for line in lines:
        a = re.split(r"\s+", line, maxsplit=1)
        x = a[0]
...
#tokenizer = AutoTokenizer.from_pretrained("../../../root/autodl-tmp/Hate-speech-CNERGhindi-codemixed-abusive-MuRIL")
#tokenizer = AutoTokenizer.from_pretrained("../../../root/autodl-tmp/cis-lmuglot500-base")
