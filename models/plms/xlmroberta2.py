...
class XLMRobertaEmbeddings(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.p_embeddings = nn.Embedding(3, config.hidden_size, padding_idx=0)
    ...
    def forward(
        self, input_ids=None,p = None, token_type_ids=None, position_ids=None, inputs_embeds=None, past_key_values_length=0
    ):
        ...
        p_embeds = self.p_embeddings(p)
        embeddings = inputs_embeds + token_type_embeddings+p_embeds
        #embeddings = inputs_embeds + p_embeds
...
class XLMRobertaForSequenceClassification2(XLMRobertaPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
    ...
    def forward(
        ...
        p_mask: Optional[torch.LongTensor] = None,
        attention_mask: Optional[torch.FloatTensor] = None,
        token_type_ids: Optional[torch.LongTensor] = None,
        position_ids: Optional[torch.LongTensor] = None,
        head_mask: Optional[torch.FloatTensor] = None,
